...
public class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Usuario>().HasData(
            new Usuario { UsuarioId = 1, NombreUsuario = "Franco", Alias = "elque vende",
                Email = "vendedor@test.com", ContrasenaHash = BCrypt.Net.BCrypt.HashPassword("Password123"),
                FechaRegistro = DateTime.UtcNow },
            new Usuario { UsuarioId = 2, NombreUsuario = "Juan", Alias = "el que compra1", Email = "comprador1@test.com",
                ContrasenaHash = BCrypt.Net.BCrypt.HashPassword("Contrasena8520"), FechaRegistro = DateTime.UtcNow },
            new Usuario { UsuarioId = 3, NombreUsuario = "Pedro", Alias = "el que compra2", Email = "comprador2@test.com",
                ContrasenaHash = BCrypt.Net.BCrypt.HashPassword("825825474"), FechaRegistro = DateTime.UtcNow },
            new Usuario { UsuarioId = 4, NombreUsuario = "Maria", Alias = "la que compra3", Email = "sinfondos@test.com",
                ContrasenaHash = BCrypt.Net.BCrypt.HashPassword("9999999"), FechaRegistro = DateTime.UtcNow }
        );
